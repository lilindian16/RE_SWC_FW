/********************************** (C) COPYRIGHT
 * ******************************* File Name          : usbd_descriptor.h Author
 *             : WCH Version            : V1.0.0 Date               : 2023/04/06
...
#define DEF_USBD_REPORT_DESC_LEN_KB                                            \
  0x27 // Size of the report descriptor in bytes
...
extern const uint8_t ConsumerRepDesc[];
