...
void Generic_Resistive_SWC::init_generic_resistive_swc(MCP4131 *mcp4131_ptr, int swc_gnd_en_pin)
{
    if (mcp4131_ptr)
    {
...
void Generic_Resistive_SWC::run_loop_test(void)
{
    while (true)
    {
        ...
        for (uint8_t i = 0; i < sizeof(required_resistances) / sizeof(required_resistances[0]); i++)
        {
